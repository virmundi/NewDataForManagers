...
This is the granddaddy of the NoSQL systems. It is so old as to not even qualify as NoSQL according to some members of the community [^kv_bdb]. To others it is a NoSQL database [^kv_bdb_how_to]. I think it is too, so I included it. 
...
* SQLite API - A Technical Evalutaiton 
...
http://www.oracle.com/technetwork/articles/audet-bdb-gwt-096313.html

* Berkeley DB Java Edition on Android 
http://www.oracle.com/technetwork/database/berkeleydb/bdb-je-android-160932.pdf
